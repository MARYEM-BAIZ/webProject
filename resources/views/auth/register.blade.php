<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div>
                <x-label for="profile_photo_url" value="{{ __('Image') }}" />
                <x-input id="profile_photo_url" class="block mt-1 w-full" type="file" name="profile_photo_url" required autofocus autocomplete="profile_photo_url" />
            </div>
